...
<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl">
            <a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml">高校教务系统</a>
...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        ...
        <dl id="menu-member">
            ...
            <dd>
                <ul>
                    <li><a data-href="<?php echo U('Region/region_list');?>" data-title="会员列表" href="javascript:;">地区列表</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-system">
            ...
            <dd>
                <ul>
                    <li><a data-href="<?php echo U('School/school_list');?>" data-title="系统设置" href="javascript:void(0)">学校列表</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-admin">
            ...
            <dd>
                <ul>
                    <li><a data-href="<?php echo U('Access/role_list');?>" data-title="角色管理" href="javascript:void(0)">角色管理</a></li>
                    <li><a data-href="<?php echo U('Access/permission_list');?>" data-title="权限管理" href="javascript:void(0)">权限管理</a></li>
                </ul>
            </dd>
        </dl>
...
<section class="Hui-article-box">
    <div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
        <div class="Hui-tabNav-wp">
            <ul id="min_title_list" class="acrossTab cl">
                <li class="active">
                    <span title="我的桌面" data-href="<?php echo U('Admin/Index/console');?>">我的桌面</span>
                    <em></em></li>
            </ul>
        </div>
    ...
    <div id="iframe_box" class="Hui-article">
        <div class="show_iframe">
            ...
            <iframe scrolling="yes" frameborder="0" src="<?php echo U('Admin/index/base');?>"></iframe>
        </div>
    </div>
</section>
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="/static/back/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
