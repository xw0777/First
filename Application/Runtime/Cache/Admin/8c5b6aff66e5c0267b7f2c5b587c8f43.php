    ...
    <form action="" method="post" class="form form-horizontal" id="form-admin-role-add">
        <div class="row cl">
            ...
            <div class="formControls col-xs-7 col-sm-8">
                <input type="text" class="input-text" value="<?php echo ($info["name"]); ?>" placeholder="" id="f_name">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">* </span>联系方式：</label>
            <div class="formControls col-xs-7 col-sm-8">
                <input type="text" class="input-text" value="<?php echo ($info["contact"]); ?>" placeholder="固话或者手机号，固话请不要带“-”" id="f_contact">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">* </span>联系人：</label>
            <div class="formControls col-xs-7 col-sm-8">
                <input type="text" class="input-text" value="<?php echo ($info["contacts"]); ?>" placeholder="" id="f_contacts">
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">* </span>地址：</label>
            <div class="formControls col-xs-7 col-sm-8">
                <input type="text" class="input-text" value="<?php echo ($info["address"]); ?>" placeholder="" id="f_address">
            </div>
        </div>
        <div class="row cl">
...
<script type="text/javascript">
    $(function(){
        ...
        $('#admin-role-save').click(function () {
            ...
            layer.load(2);
            $.post('<?php echo U("edit_school");?>',{id:id,name:name,contact:contact,contacts:contacts,address:address,region:region}, function (e) {
               // console.log(e);
